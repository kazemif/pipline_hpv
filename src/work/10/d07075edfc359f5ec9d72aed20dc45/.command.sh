...
samtools flagstat barcode13.sorted.bam > barcode13_read_alignment_stats/mapped_unmapped.txt

# 2. Statistiques par read
samtools view barcode13.sorted.bam | awk '
BEGIN {
    OFS="\t"
...
' > barcode13_read_alignment_stats/per_read_stats.tsv
