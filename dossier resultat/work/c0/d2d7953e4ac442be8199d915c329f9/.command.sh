...
python3 /home/etudiant/fatemeh/stage_fatemeh_2025/tools/Python/parse_fastq/src/parse_fastq/main.py         --input barcode14_trimmed.fastq         --output output_barcode14         --sample barcode14
