...
python3 /home/etudiant/fatemeh/stage_fatemeh_2025/tools/Python/parse_fastq/src/parse_fastq/main.py         --input barcode09_trimmed.fastq         --output output_barcode09         --sample barcode09
